...
const INITIAL_DISHES = [
  { id: "dish-1", name: "Dumplings (Steam) - Veg", price: 79, category: "Starters", dietary: "veg", description: "Dumplings are soft dough pockets filled with fresh seasoned vegetables, then steamed and served with a flavorful dipping sauce.", isSoldOut: false },
  { id: "dish-2", name: "Dumplings (Steam) - Chicken", price: 99, category: "Starters", dietary: "non-veg", description: "Dumplings are soft dough pockets filled with succulent chicken and savory seasonings, then steamed and served with a flavorful dipping sauce.", isSoldOut: false },
  { id: "dish-3", name: "Dumplings (Fried) - Veg", price: 79, category: "Starters", dietary: "veg", description: "Dumplings are soft dough pockets filled with fresh seasoned vegetables, fried until crispy and served with a flavorful dipping sauce.", isSoldOut: false },
  { id: "dish-4", name: "Dumplings (Fried) - Chicken", price: 99, category: "Starters", dietary: "non-veg", description: "Dumplings are soft dough pockets filled with succulent chicken and savory seasonings, fried until crispy and served with a flavorful dipping sauce.", isSoldOut: false },
  { id: "dish-5", name: "ChowMein - Veg", price: 69, category: "Mains", dietary: "veg", description: "Chow Mein is a classic Indo-Chinese stir-fried noodle dish made with fresh, crisp vegetables and savory aromatic seasonings.", isSoldOut: false },
  { id: "dish-6", name: "ChowMein - Egg", price: 79, category: "Mains", dietary: "non-veg", description: "Chow Mein is a savory stir-fried noodle dish prepared with fluffy scrambled eggs and crisp vegetables.", isSoldOut: false },
  { id: "dish-7", name: "ChowMein - Chicken", price: 99, category: "Mains", dietary: "non-veg", description: "Chow Mein is a savory stir-fried noodle dish made with tender chicken, crisp vegetables, and aromatic Indo-Chinese seasonings.", isSoldOut: false },
